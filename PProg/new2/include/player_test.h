...
/**
 * @test Test function for player_stat adding
 * @pre Player NULL
 * @post Output == ERROR
 */
 ...
 * @test Test function for player_stat adding
 * @pre Player
 * @post Player_atk == Supplied atk
 */
void test2_player_add_stat();

/**
 * @test Test function for player_stat substracting
 * @pre Player NULL
 * @post Output == ERROR
 */
 ...
 * @test Test function for player_stat substracting
 * @pre Player
 * @post Player_def == Supplied def
 */
void test2_player_subs_stat();

/**
 * @test Test function for player_atk getting
 * @pre Player NULL
 * @post Output == 0
 */
 ...
 * @test Test function for player_atk getting
 * @pre Player
 * @post Output == Supplied player_atk
 */
void test2_player_get_atk();

/**
 * @test Test function for player_def getting
 * @pre Player NULL
 * @post Output == 0
 */
 ...
 * @test Test function for player_def getting
 * @pre Player
 * @post Output == Supplied player_def
 */
