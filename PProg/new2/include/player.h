...
/**
 * @brief Positive stat increments ATK and negative stat increments DEF
 * @author Diego Fernández
 *
 * @param p target player
 * @param stat increment
 * @return OK if successful, ERROR if there was an issue
 */
STATUS player_add_stat(Player *p, const int stat);

/**
 * @brief Positive stat decrements ATK and negative stat decrements DEF
 * @author Diego Fernández
 *
 * @param p target player
 * @param stat decrement
 * @return OK if successful, ERROR if there was an issue
 */
STATUS player_subs_stat(Player *p, const int stat);

/**
 * @brief It gets the atk stat from the player
 * @author Diego Fernández
 *
 * @param p target player
 * @return atk stat, 0 if there was an issue
 */
int player_get_atk(const Player *p);

/**
 * @brief It gets the def stat from the player
 * @author Diego Fernández
 *
 * @param p target player
 * @return def stat, 0 if there was an issue
 */
