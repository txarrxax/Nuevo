...
/**
 * @brief Gets the last description of the game
 * @author Miguel Angel Sacristan
 *
 * @param game a pointer to the game session
...
/**
 * @brief Sets the last dialogue of the game
...
/**
 * @brief Gets the last dialogue of the game
 * @author Alberto Tarrasa
 *
 * @param game a pointer to the game session
 * @return the last dialogue if the game
 */
...
/**
 * @brief It gets the space array from the game struct
 * @author Diego Fernández
 *
 * @param game a pointer to the game session
 * @return a pointer to the space array or NULL if there was an issue
 */
const Space **game_get_all_spaces(const Game *game);

/**
 * @brief It gets the object array from the game struct
 * @author Diego Fernández
 *
 * @param game a pointer to the game session
 * @return a pointer to the object array or NULL if there was an issue
 */
const Object **game_get_all_objects(const Game *game);

/**
 * @brief It gets the number of links
 * @author Diego Fernández
 *
 * @param game a pointer to the game session
 * @return the number of links or -1 if there was an issue
 */
int game_get_num_links(const Game *game);

/**
 * @brief It gets the link array from the game struct
 * @author Diego Fernández
 *
 * @param game a pointer to the game session
 * @return a pointer to the link array or NULL if there was an issue
 */
const Link **game_get_all_links(const Game *game);

/**
 * @brief Destroys enemy struct and sets its pointer to NULL
 * @author Diego Fernández
 *
 * @param game a pointer to the game session
 * @return OK if successful, ERROR if there was an issue
...
/**
 * @brief Gets a link from its id number
 * @author Miguel Angel Sacristan
 *
 * @param game a pointer to the game session
 * @param link id number of the link
 * @return the link if successful, ERROR if there was an issue
 */
