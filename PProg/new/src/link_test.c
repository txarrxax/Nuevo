...
int main(int argc, char **argv) {
  ...
  if (all || test == 12) test1_link_get_dest();
  if (all || test == 13) test2_link_get_dest();
  if (all || test == 14) test1_link_get_direction();
  if (all || test == 15) test2_link_get_direction();
  if (all || test == 16) test1_link_get_status();
  if (all || test == 17) test2_link_get_status();
  if (all || test == 18) test1_link_set_name();
  if (all || test == 19) test2_link_set_name();
  if (all || test == 20) test1_link_set_origin();
  if (all || test == 21) test2_link_set_origin();
  if (all || test == 22) test1_link_set_dest();
  if (all || test == 23) test2_link_set_dest();
  if (all || test == 24) test1_link_set_direction();
  if (all || test == 25) test2_link_set_direction();
  if (all || test == 26) test1_link_set_status();
  if (all || test == 27) test2_link_set_status();
  if (all || test == 28) test1_link_print();
  if (all || test == 29) test2_link_print();
...
void test2_link_destroy() {
  PRINT_TEST_RESULT(link_destroy(NULL) == ERROR);
}
...
void test1_link_get_dest() {
  PRINT_TEST_RESULT(link_get_dest(NULL) == NO_ID);
}
...
void test2_link_set_name() {
  ...
  if (!link_set_name(link, TEST_LINK_NAME)) PRINT_TEST_RESULT(FALSE);
